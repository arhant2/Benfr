...
},{"./lib/axios":"../../../node_modules/axios/lib/axios.js"}],"components-function/flash-messages.js":[function(require,module,exports) {
"use strict";
...
},{}],"../../../utils/singularPluralManager.js":[function(require,module,exports) {
var capitilize = require('./capitilize');

module.exports = function (singularNameParam, pluralNameParam) {
...
},{"./capitilize":"../../../utils/capitilize.js"}],"pages/each-product__template.js":[function(require,module,exports) {
"use strict";
...
exports.productFormDataSpecificationsManage = void 0;
...
var productFormDataSpecificationsManage = function productFormDataSpecificationsManage(formData) {
  var fields = formData.getAll('specifications[{%NUM%}][field]');
  var values = formData.getAll('specifications[{%NUM%}][value]');
  console.log(values);

  for (var i = 0; i < fields.length; ++i) {
    formData.append("specifications[".concat(i, "][field]"), fields[i]);
    formData.append("specifications[".concat(i, "][value]"), values[i]);
  }
...
exports.productFormDataSpecificationsManage = productFormDataSpecificationsManage;
},{"./each-product__template":"pages/each-product__template.js"}],"ajax/generic-form.js":[function(require,module,exports) {
"use strict";
...
var form = document.getElementById('generic-form');
var saveBtn = document.getElementById('form-save-btn');
var deleteBtn = document.getElementById('form-delete-btn');
var discardBtn = document.getElementById('form-discard-btn');
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (singularName.small === 'product') {
                (0, _eachProduct.productFormDataSpecificationsManage)(data);
              }
              ...
              if (isNew) {
                obj.url = "/api/v1/".concat(pluralName.small);
                obj.method = 'POST';
              } else {
                obj.url = "/api/v1/".concat(pluralName.small, "/").concat(id);
                obj.method = 'PATCH';
              }
            ...
            case 8:
              ...
              if (isNew) {
                ...
                (0, _flashMessages.addFlashMessage)('success', "Successfully updated ".concat(singularName.small, ". Reloading..."));
                setTimeout(function () {
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return (0, _axios.default)({
                method: 'DELETE',
                url: "/api/v1/".concat(pluralName.small, "/").concat(id)
              });

            case 4:
              res = _context2.sent;
              (0, _flashMessages.addFlashMessage)('success', "Deleted ".concat(singularName.small, " successfully! Reloading..."));
              setTimeout(function () {
                window.location.href = "/a/".concat(pluralName.small);
              }, 2000);
              _context2.next = 13;
              break;
...
if (form) {
  var singularNameGenericForm = form.dataset.genericFormSingularName;
  var pluralNameGenericForm = form.dataset.genericFormPluralName;

  if (singularNameGenericForm && pluralNameGenericForm) {
    var _singularPluralManage = (0, _singularPluralManager.default)(singularNameGenericForm, pluralNameGenericForm);

    singularName = _singularPluralManage.singularName;
    pluralName = _singularPluralManage.pluralName;
    submitForm();
  }
...
},{"moment":"../../../node_modules/moment/moment.js"}],"../../../node_modules/color-name/index.js":[function(require,module,exports) {
'use strict'
...
},{"color-name":"../../../node_modules/color-name/index.js"}],"../../../node_modules/color-alpha/index.js":[function(require,module,exports) {
'use strict'
...
},{"color-parse":"../../../node_modules/color-parse/index.js"}],"utils/cssGlobalVariables.js":[function(require,module,exports) {
"use strict";
...
for (var i = 0; i < document.styleSheets.length; ++i) {
  ...
  for (var j = 0; j < styleSheet.cssRules.length; ++j) {
    ...
    for (var k = 0; k < rule.style.length; ++k) {
      var style = rule.style[k];

      if (!style.startsWith('--')) {
        continue;
      }

      ans[style] = window.getComputedStyle(document.documentElement).getPropertyValue(style).trim();
    }
  }
}
},{}],"components-function/chart.js":[function(require,module,exports) {
"use strict";
...
var _cssGlobalVariables = _interopRequireDefault(require("../utils/cssGlobalVariables"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

Array.from(document.getElementsByClassName('js--components-function--chart')).forEach(function (element) {
  var chardata = JSON.parse(element.dataset.chartdata);
  var label = chardata.label;
  var titles = chardata.data.map(function (el) {
    return el.title;
  });
  var data = chardata.data.map(function (el) {
    return el.value;
  });
  var colors = JSON.parse(element.dataset.chartcolors);
  var type = element.dataset.charttype;

  for (var i = 0; i < colors.length; i++) {
    if (_cssGlobalVariables.default["--color-".concat(colors[i])]) {
      colors[i] = _cssGlobalVariables.default["--color-".concat(colors[i])];
    }
  }
    ...
    new Chart(element, {
      ...
      data: {
        ...
        datasets: [{
          label: label,
          data: data,
          backgroundColor: (0, _colorAlpha.default)(colors[0], 0.5),
...
},{"chart.js":"../../../node_modules/chart.js/dist/Chart.js","color-alpha":"../../../node_modules/color-alpha/index.js","../utils/cssGlobalVariables":"utils/cssGlobalVariables.js"}],"components-function/dropdown.js":[function(require,module,exports) {
...
require("./components-function/flash-messages");
